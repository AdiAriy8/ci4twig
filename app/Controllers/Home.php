...
class Home extends BaseController
{
    ...
    public function login()
    {
       ...
       $login_data = [];
        ...
        // Jika ada permintaan POST (form login dikirim)
        if ($this->request->getMethod() === 'post') {
            // Anda dapat menambahkan logika validasi login di sini
            ...
            if ($username === 'admin' && $password === 'password') {
                ...
                return redirect()->to('selengkapnya');
            } else {
                // Jika login gagal, tampilkan pesan error
                $login_data['error'] = 'Username atau password salah!';
            }
        }

        // Tampilkan halaman login
        return $this->render('login.twig', $data, $login_data);
    }
